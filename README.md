...
We are happy to accept contributions from anybody. Get in Discord if you want to help. We've got a [list of issues](https://github.com/https://github.com/John-Enterprises-Ltd/LarpMed-content/issues) that need to be done and anybody can pick them up. Don't be afraid to ask for help either!
...
All code for the content repository is licensed under the [MIT license](https://github.com/https://github.com/John-Enterprises-Ltd/LarpMed/blob/master/LICENSE.TXT).
